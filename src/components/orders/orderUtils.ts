...
// Jednotny slovnik stavov objednavky (28.7.2026) — sedem hodnot:
// pending_approval → growing → packed → on_the_way → delivered, plus cancelled a paused.
...
export const STATUS_STEPS = [
  { keys: ['pending_approval'], label: 'Čaká na schválenie' },
  { keys: ['growing'],          label: 'Rastie'   },
  { keys: ['packed'],           label: 'Zabalená' },
  { keys: ['on_the_way'],       label: 'Na ceste' },
  { keys: ['delivered'],        label: 'Doručená' },
];
